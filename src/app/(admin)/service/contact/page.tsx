...
const ContactPage = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/contact/${contactToDelete}`,
        {
          method: "DELETE",
  ...
  const handleRefresh = () => {
    ...
    toast.success("Uppdaterad", {
      description: "Kontaktlistan har uppdaterats.",
    });
  };
  ...
  return (
    <div className="container mx-auto py-10 space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Hantera och granska inkomna kontaktförfrågningar
          </p>
        </div>
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="relative">
            ...
            <Input
              placeholder="Sök efter namn, e-post, telefon eller ämne..."
              value={searchQuery}
      ...
      <Card>
        <CardHeader>
          <CardTitle>Alla kontakter</CardTitle>
          <CardDescription>
            {filteredContacts.length} av {contacts.length} kontakter visas
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="mt-4 text-lg font-semibold">Inga kontakter</h3>
              <p className="text-muted-foreground">
                {searchQuery
                  ? "Inga kontakter matchade din sökning"
                  : "Inga kontaktförfrågningar har kommit in än"}
              </p>
            </div>
          ) : (
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>Kontaktdetaljer</DialogTitle>
            <DialogDescription>
              Fullständig information om kontaktförfrågan
            </DialogDescription>
          </DialogHeader>
          {selectedContact && (
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Denna åtgärd kan inte ångras. Kontakten kommer att raderas
              permanent.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
